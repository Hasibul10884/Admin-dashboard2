<div class="header_section">
    <div class="container">
       <nav class="navbar navbar-dark bg-dark">
          <a class="logo" href="index.html"><img src="{{url('frontend/images/logo.png')}}"></a>
          <div class="search_section">
             <ul>
                <li><a href="#">Log In</a></li>
                <li><a href="#"><img src="{{url('frontend/images/shopping-bag.png')}}"></a></li>
                <li><a href="#"><img src="{{url('frontend/images/search-icon.png')}}"></a></li>
             </ul>
          </div>
    ...
    <div class="banner_section layout_padding">
       <div id="my_slider" class="carousel slide" data-ride="carousel">
          ...
          <i class=""><img src="{{url('fronted/images/left-icon.png')}}"></i>
          </a>
          <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next">
          <i class=""><img src="{{url('frontend/images/right-icon.png')}}"></i>
          </a>
       </div>
    </div>
    <!--banner section end -->
